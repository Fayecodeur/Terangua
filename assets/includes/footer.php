                              ...
                              <div class="footer-flex-box">
                                  <div class="footer-table-info">
                                      ...
                                      <ul>
                                          ...
                                          <li>
                                              <i class="uil uil-clock"></i> Sam-Dim : 9h - 00h
                                          </li>
                                      </ul>
                                  </div>
                                  <div class="footer-menu food-nav-menu">
                                      ...
                                      <ul class="column-2">
                                          ...
                                          <?php else : ?>
                                              ...
                                              <li><a href="reservation">Résrvation</a></li>
                  ...
                  <div class="row">
                      <div class="col-lg-12 text-center">
                          <div class="copyright-text">
                              <p>
                                  Copyright &copy; 2024 Térangua Délice. Tous droits
                                  réservés.
