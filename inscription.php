...
$titre = "Inscription";
require_once("assets/includes/headerRegister.php");
?>
  ...
  <form id="form" method="post" action="">
    ...
    <div class="input-group">
      <div class="input-control">
        ...
        <input type="text" id="prenom" name="prenom" autocomplete="off" value="<?= htmlspecialchars($prenom); ?>" />
        <span class="error"><?= $prenomErr; ?></span>
      </div>
      <div class="input-control">
        <label for="nom">Nom</label>
        <input type="text" id="nom" name="nom" autocomplete="off" value="<?= htmlspecialchars($nom); ?>" />
        <span class="error"><?= $nomErr; ?></span>
      </div>
    </div>
    <div class="input-control">
      <label for="email">Adresse email</label>
      <input type="email" class="form-control" name="email" autocomplete="off" id="email" value="<?= htmlspecialchars($email); ?>">
...
<?php require_once("assets/includes/footerRegister.php"); ?>