...
require_once("assets/includes/headerLogin.php");
?>
...
<div class="container mt-4">
  <form id="form" method="post" action="">
    ...
    <div class="input-control">
      ...
      <input id="email" name="email" value="<?= htmlspecialchars($email); ?>" type="text" autocomplete="off" />
      <span class="error"><?= $emailErr; ?></span>
    </div>
    <div class="input-control">
      <label for="password">Mot de passe</label>
      <input id="password" name="mdp" type="password" autocomplete="off" />
